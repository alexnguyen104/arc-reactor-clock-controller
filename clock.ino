...
String URL = "http://192.168.1.26:5432/data";
...
void loop() {
  ...
  if (httpCode > 0) {
    ...
    // const char* ngay = obj["ngay"].as<const char*>();
    // const char* thang = obj["thang"].as<const char*>();

    //color
    const String r = doc["color"]["r"];
    const String g = doc["color"]["g"];
    const String b = doc["color"]["b"];

    const String brightness = doc["brightness"];
